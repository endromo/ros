    ...
    var t = Object.create(null),
      o =
        ...
        n.console &&
          n.console.log &&
          ((s && e("3.0.0")) ||
            n.console.log("ROS by Endro: jQuery 3.0.0+ REQUIRED"),
          s.migrateWarnings &&
            n.console.log("ROS by Endro: Migrate plugin loaded multiple times"),
          n.console.log(
            "INFO: ROS by endro.mono9 @ gmail . com is installed" +
              (s.migrateMute ? "" : " with logging active") +
              ", landingpage migrate version " +
              s.migrateVersion
          )
        ),
        {});
...
jQuery("head").append(
  '<style type="text/css">.fc_content{display:none;}</style>'
);
